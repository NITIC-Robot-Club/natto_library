...
#ifndef __OMNI_VISUALIZER_HPP__
#define __OMNI_VISUALIZER_HPP__
...
class omni_visualizer : public rclcpp::Node {
   public:
    omni_visualizer (const rclcpp::NodeOptions &node_options);
   ...
   private:
    ...
    rclcpp::Subscription<natto_msgs::msg::Omni>::SharedPtr             omni_subscription_;
    rclcpp::TimerBase::SharedPtr                                       timer_;
};
}  // namespace omni_visualizer

#endif  // __OMNI_VISUALIZER_HPP__