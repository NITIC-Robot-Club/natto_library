...
class mcl : public rclcpp::Node {
   ...
   private:
    ...
    double      motion_noise_position_, motion_noise_orientation_;
    double      alpha_threshold_, expansion_radius_position_, expansion_radius_orientation_, laser_likelihood_max_dist_;
