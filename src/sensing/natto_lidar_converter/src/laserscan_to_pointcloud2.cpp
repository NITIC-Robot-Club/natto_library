...
laserscan_to_pointcloud2::laserscan_to_pointcloud2 (const rclcpp::NodeOptions &node_options) : Node ("laserscan_to_pointcloud2", node_options) {
    ...
    laserscan_subscriber_  = this->create_subscription<sensor_msgs::msg::LaserScan> ("laserscan", 10, std::bind (&laserscan_to_pointcloud2::laserscan_callback, this, std::placeholders::_1));
