...
| lidar_timeout_seconds | double | 0.1 | 最後に受信したLiDARデータがこの秒数を超えて古くなったら無効扱いにする |
...
LiDAR が切れるなどして最後に受信した点群の有効期限が切れた場合、その点群は使わず、自己位置は odometry 由来の fallback で更新します。LiDAR が復帰したら、odometry 側の姿勢を基準に粒子を再初期化して通常の MCL に戻ります。
